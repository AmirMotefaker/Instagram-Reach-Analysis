...
The Phase 6 GitHub Actions workflow validates notebook JSON structure and scans committed text for obvious API-key patterns. No live Instagram or external API request is made.
